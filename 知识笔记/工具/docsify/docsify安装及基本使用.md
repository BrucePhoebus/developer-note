...
```
*可以参考*：[package.json](https://github.com/BrucePhoebus/development-learning/tree/big-file/package.json)
...
*参考配置*：[index.html](https://github.com/BrucePhoebus/development-learning/tree/big-file/index.html)
